...
const expects: [string, string][] = [
  ...
  ["ring-offset-1", ".ring-offset-0{--map-ring-offset-width:1px;}"],
  ["ring-offset-2", ".ring-offset-0{--map-ring-offset-width:2px;}"],
  ["ring-offset-4", ".ring-offset-0{--map-ring-offset-width:4px;}"],
  ["ring-offset-8", ".ring-offset-0{--map-ring-offset-width:8px;}"],
