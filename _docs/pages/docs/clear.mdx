...
<Example resizable p="none">
  <div className="mx-4 bg-white shadow-xl p-8 text-slate-700 text-sm sm:text-base leading-6 sm:leading-7 dark:bg-slate-800 dark:text-slate-400">
    <div className="float-left mb-4 rounded-xl overflow-hidden">
      <div className="relative aspect-w-1 aspect-h-1 sm:aspect-w-16 sm:aspect-h-9 w-24 sm:w-44">
        <img
    ...
    <div className="float-right ml-6 mb-4 rounded-xl overflow-hidden ">
      <div className="relative aspect-w-1 aspect-h-1 sm:aspect-w-16 sm:aspect-h-9 w-40 sm:w-64">
        <img
          className="object-cover"
          src="https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=320&q=80"
        />
    ...
    <p className="clear-left text-justify">
      ...
      Chinese Brothers? Doesn't HE deserve better? Look. If you think this is
...
<p className="**clear-left** ...">Maybe we can live without libraries...</p>
```
...
<Example resizable p="none">
  <div className="mx-4 bg-white shadow-xl p-8 text-slate-700 text-sm sm:text-base leading-6 sm:leading-7 dark:bg-slate-800 dark:text-slate-400">
    <div className="float-left mr-6 mb-4 rounded-xl overflow-hidden">
      <div className="relative aspect-w-4 aspect-h-5 sm:aspect-w-16 sm:aspect-h-9 w-28 sm:w-64">
        <img
          className="object-cover"
          src="https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=320&q=80"
        />
...
<img className="float-left ..." src="path/to/image.jpg" />
<img className="float-right ..." src="path/to/image.jpg" />
<p className="**clear-right** ...">Maybe we can live without libraries...</p>
```
...
<Example resizable p="none">
  <div className="mx-4 bg-white shadow-xl p-8 text-slate-700 text-sm sm:text-base leading-6 sm:leading-7 dark:bg-slate-800 dark:text-slate-400">
    <div className="float-left mb-4 rounded-xl overflow-hidden">
      <div className="relative aspect-w-16 aspect-h-9 w-44">
        <img
          className="object-cover"
          src="https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=320&q=80"
        />
    ...
    <div className="float-right ml-6 mb-4 rounded-xl overflow-hidden ">
      <div className="relative aspect-w-16 aspect-h-9 w-64">
        <img
          className="object-cover"
          src="https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=320&q=80"
        />
...
<img className="float-left ..." src="path/to/image.jpg" />
<img className="float-right ..." src="path/to/image.jpg" />
<p className="**clear-both** ...">Maybe we can live without libraries...</p>
```
