...
<Example p="none">
  ...
  <div className="flex items-center justify-around gap-6 sm:gap-4 font-mono font-bold shrink-0 p-8">
    <div className="flex flex-col items-center shrink-0">
      <p className="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">backdrop-brightness-50</p>
    ...
    <div className="flex flex-col items-center shrink-0">
      <p className="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">backdrop-brightness-125</p>
      <div className="relative">
    ...
    <div className="flex flex-col items-center shrink-0">
      <p className="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">backdrop-brightness-200</p>
      <div className="relative">
...
<div className="**backdrop-brightness-125** bg-white/30 ...">
  <!-- ... -->
</div>
<div className="**backdrop-brightness-200** bg-white/30 ...">
  <!-- ... -->
</div>
```
