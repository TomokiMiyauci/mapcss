...
<Example>
  <div className="font-mono text-white text-sm font-bold leading-6">
    <div className="grid grid-cols-3 gap-4 content-start w-full rounded-lg bg-stripes-purple text-center h-56">
...
<Example>
  <div className="font-mono text-white text-sm font-bold leading-6">
    <div className="grid grid-cols-3 gap-4 content-center w-full rounded-lg bg-stripes-sky text-center h-56">
...
<Example>
  <div className="font-mono text-white text-sm font-bold leading-6">
    <div className="grid grid-cols-3 gap-4 content-end w-full rounded-lg bg-stripes-pink text-center h-56">
...
<Example>
  <div className="font-mono text-white text-sm font-bold leading-6">
    <div className="grid grid-cols-3 gap-4 content-between w-full rounded-lg bg-stripes-violet text-center h-56">
...
<Example>
  <div className="font-mono text-white text-sm font-bold leading-6">
    <div className="grid grid-cols-3 gap-x-4 content-around w-full rounded-lg bg-stripes-blue text-center h-56">
...
<Example>
  <div className="font-mono text-white text-sm font-bold leading-6">
    <div className="grid grid-cols-3 gap-x-4 content-evenly w-full rounded-lg bg-stripes-indigo text-center h-56">
