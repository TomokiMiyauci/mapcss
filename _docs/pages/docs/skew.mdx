...
<Example p="none">
  ...
  <div className="flex items-center justify-around gap-12 sm:gap-4 font-mono font-bold p-8 shrink-0">
    <div className="flex flex-col items-center shrink-0">
      <p className="font-medium text-sm text-slate-500 font-mono text-center mb-9 dark:text-slate-400">skew-y-0</p>
    ...
    <div className="flex flex-col items-center shrink-0">
      <p className="font-medium text-sm text-slate-500 font-mono text-center mb-9 dark:text-slate-400">skew-y-3</p>
      <div className="relative">
        <div className="absolute inset-0">
          <img className="w-24 h-24 object-cover rounded-lg opacity-25" src="https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=320&h=320&q=80" />
        </div>
    ...
    <div className="flex flex-col items-center shrink-0">
      <p className="font-medium text-sm text-slate-500 font-mono text-center mb-9 dark:text-slate-400">skew-y-6</p>
      <div className="relative">
        <div className="absolute inset-0">
          <img className="w-24 h-24 object-cover rounded-lg opacity-25" src="https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=320&h=320&q=80" />
        </div>
    ...
    <div className="flex flex-col items-center shrink-0">
      <p className="font-medium text-sm text-slate-500 font-mono text-center mb-9 dark:text-slate-400">skew-y-12</p>
      <div className="relative">
        <div className="absolute inset-0">
          <img className="w-24 h-24 object-cover rounded-lg opacity-25" src="https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=320&h=320&q=80" />
        </div>
...
```html
<img className="**skew-y-0** ...">
<img className="**skew-y-3** ...">
<img className="**skew-y-6** ...">
<img className="**skew-y-12** ...">
```
